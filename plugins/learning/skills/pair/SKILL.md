...
allowed-tools: Bash(${CLAUDE_SKILL_DIR}/../../bin/learn-session *), Bash(${CLAUDE_SKILL_DIR}/../../bin/learn-log *), Bash(${CLAUDE_SKILL_DIR}/../../bin/learn-profile *), Bash(${CLAUDE_SKILL_DIR}/../../bin/learn-vocab *), Bash(${CLAUDE_SKILL_DIR}/../../bin/learn-queue *), Bash(${CLAUDE_SKILL_DIR}/../../bin/learn-baseline *), Bash(${CLAUDE_SKILL_DIR}/../../bin/bench *), Bash(git log *), Bash(git diff *), Bash(git show *), Bash(git status *), Bash(git rev-parse *)
---
...
2. **Discuss the approach before they start.** This is a real back-and-forth, not a formality:
   ...
   named. Keep it terse on architecture (they are strong there). Slow down on anything touching a
   growth edge in the profile.
...
6. Close with **two or three sentences maximum**. They are a lead developer at the end of a working
